...
var KTApp = function() {
    ...
    return {
        init: function() {
            !0 !== e && SmoothScroll && new SmoothScroll('a[data-kt-scroll-toggle][href*="#"]',{
                speed: 1e3,
                speedAsDuration: !0,
                offset: function(e, t) {
  ...
  , KTMenu = function(e, t) {
    ...
    if (null != e) {
        var i = {
          ...
          , a = function(e) {
            e || (e = n.triggerElement),
            !0 !== m(e) && ("dropdown" === v(e) ? U(e) : "accordion" === v(e) && A(e),
          ...
          , x = function(e) {
            ...
            if (i && i.length > 0)
                for (var r = 0, o = i.length; r < o; r++)
                    t = i[r],
                    "accordion" === v(t) && t !== e && !1 === e.contains(t) && !1 === t.contains(e) && I(t)
        }
          , L = function(e, t) {
            var n, i = null;
  ...
  , KTScroll = function(e, t) {
    ...
    if (e) {
        var i = {
          ...
          , p = function() {
            return f("height") ? "height" : f("min-height") ? "min-height" : f("") ? "" : void 0
        };
  ...
  , KTSticky = function(e, t) {
    ...
    if (null != e) {
        var i = {
          ...
          , o = function(e) {
            var t, i, r = u("offset"), o = u("release-offset"), s = u("reverse");
            if (!1 !== r) {
                if (r = parseInt(r),
                o = o ? parseInt(o) : 0,
                t = KTUtil.getScrollTop(),
                i = document.documentElement.scrollHeight - window.innerHeight - KTUtil.getScrollTop(),
                !0 === s) {
                    if (t > r && (0 === o || o < i)) {
...
var KTAppLayoutBuilder = function() {
    ...
    return {
        init: function() {
            ...
            s && (s.closest(".form-check-image").classList.add("active"),
            s.checked = !0))
        }
    }
}();
...
var KTThemeMode = function() {
    var e, t = this, n = function() {
        ...
        s && (localStorage.setItem("data-theme-mode", r),
        a(s)),
