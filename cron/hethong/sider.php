...
<div class="app-sidebar-logo px-6" id="kt_app_sidebar_logo">
  ...
  margin-right: auto;">
						...
						<div class="app-sidebar-menu overflow-hidden flex-column-fluid">
                            ...
                            <!--end:Menu link-->
									...
									<div data-kt-menu-trigger="click" class="menu-item menu-accordion">
										...
										<span class="menu-link">
											<span class="menu-icon">
												<i class="fa-solid fa-server fs-3">
													<span class="path1"></span>
													<span class="path2"></span>
													<span class="path3"></span>
													<span class="path4"></span>
    ...
    <div class="menu-sub menu-sub-accordion">
        <div class="menu-item">
            <a class="menu-link" href="/quanly-license">
                <span class="menu-bullet">
                    <span class="bullet bullet-dot"></span>
                </span>
                <span class="menu-title">Mua Key License</span>
            </a>
        </div>
        <div class="menu-item">
            <a class="menu-link" href="/quanly-license">
                ...
                <span class="menu-title">Quản Lý License</span>
            </a>
        </div>
        <div class="menu-item">
    ...
    <span class="menu-link">
        <span class="menu-icon">
            <i class="fa-solid fa-newspaper fs-5">
                <span class="path1"></span>
                <span class="path2"></span>
                <span class="path3"></span>
                <span class="path4"></span>
        ...
        <span class="menu-icon">
           ...
           <span class="menu-arrow"></span>
                                    ...
                                    <div data-kt-menu-trigger="click" class="menu-item menu-accordion">
										...
										<span class="menu-link">
											<span class="menu-icon">
												<i class="fa fa-credit-card fs-3">
													<span class="path1"></span>
													<span class="path2"></span>
												</i>
											</span>
