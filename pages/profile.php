...
<head>
    ...
    <title>Profile | <?=$chinhapi['ten_web'];?></title>
                    ...
                    <div class="container-xxl" id="kt_content_container">
                        ...
                        <div class="card mb-5 mb-xl-10">
                            ...
                            <div class="symbol symbol-100px symbol-lg-160px symbol-fixed position-relative">
                                <img src="https://i.imgur.com/88cZr2R.png" alt="image" />
                                <div
                            ...
                            <div class="card-body p-9">
                                ...
                                <div class="row mb-7">
                                    ...
                                    <div class="col-lg-8 d-flex align-items-center">
                                        <span
                                            class="fw-bolder fs-6 me-2 text-gray-800"><?=tien($user['money']);?>đ</span>
                                ...
                                <div class="row mb-7">
                                    ...
                                    <div class="col-lg-8">
                                        <a href="#"
                                            class="fw-bold fs-6 text-gray-800 text-hover-primary"><?=$user['ip'];?></a>
                                    </div>
                                    <!--end::Col-->
                                </div>
                                <!--end::Input group-->
                                ...
                                <div class="row mb-7">
                                    <!--begin::Label-->
                                    <label class="col-lg-4 fw-bold text-muted">Ngày đăng ký
                                        <i class="fas fa-exclamation-circle ms-1 fs-7" data-bs-toggle="tooltip"
                                            title="Đây là thời điểm bạn đăng ký tài khoản"></i></label>
                                    <!--end::Label-->
                                    <!--begin::Col-->
                                    <div class="col-lg-8">
                                        <span class="fw-bolder fs-6 text-gray-800"><?=$user['time'];?></span>
                                    </div>
                                    <!--end::Col-->
                                </div>
                                <!--end::Input group-->
