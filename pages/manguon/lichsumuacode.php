...
<head>
    ...
    <title>Kho Code | <?=$chinhapi['ten_web'];?></title>
                                ...
                                <div class="card card-xl-stretch mb-5 mb-xl">
                                    ...
                                    <div class="card-header border-0 pt-5">
                                        <h3 class="card-title align-items-start flex-column">
                                            <span class="card-label fw-bolder fs-3 mb-1">Lịch sử mua code</span>
                                        ...
                                        <div class="table-responsive">
                                            ...
                                            <table
                                                ...
                                                <thead>
                                                    <tr class="fw-bolder text-muted">
                                                        ...
                                                        <th class="min-w-150px">Mã Giao Dịch</th>
                                                        <th class="min-w-150px">Mã Nguồn</th>
                                                ...
                                                <tbody>
                                                    <?php
                                            $result = mysqli_query($ketnoi,"SELECT * FROM `lich_su_mua_code` WHERE `username` = '$username'ORDER BY `id` DESC ");
                                            while($row = mysqli_fetch_assoc($result)) { ?>
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <a href=""
                                                                class="text-dark fw-bolder text-hover-primary d-block fs-6"><?=$row['trans_id'];?></a>
                                                        </td>
                                                        <td>
                                                            <a 
                                                                class="text-dark fw-bolder text-hover-primary d-block fs-6"><?=$code['title'];?></a>
                                                        </td>
                                                        <td>
                                                            <a
                                                                class="text-dark fw-bolder text-hover-primary d-block fs-6"><?=ngay($row['time']);?></a>
                                                        </td>
                                                        <td>
                                                            <a
                                                                class="text-dark fw-bolder text-hover-primary d-block fs-6"><?=code($row['status']);?></a>
                                                        </td>
                                                        <td>
