...
<head>
    ...
    <title>Đổi mật khẩu | <?=$chinhapi['ten_web'];?></title>
    ...
    <div class="d-flex flex-column flex-root app-root" id="kt_app_root">
                    ...
                    <div class="container-xxl" id="kt_content_container">
                        ...
                        <div class="card mb-5 mb-xl-10">
                            ...
                            <div class="symbol symbol-100px symbol-lg-160px symbol-fixed position-relative">
                                <img src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRgxxVg_Fj45Ppn2Vo5mErte_9CbxSXMvnwAg&usqp=CAU" alt="image" />
                                <div
                        ...
                        <div class="flex-grow-1">
                            ...
                            <div class="d-flex justify-content-between align-items-start flex-wrap mb-2">
                                ...
                                <div class="d-flex flex-column">
                                    ...
                                    <div class="d-flex align-items-center mb-2">
                                        ...
                                        <a href="#" class="btn btn-sm btn-light-success fw-bolder ms-2 fs-8 py-1 px-3"
                                            ...
                                            data-bs-target="#kt_modal_upgrade_plan"><?=tien($user['money']);?>đ</a>
                                    </div>
                                    <!--end::Name-->
                                    <!--begin::Info-->
                                ...
                                <div class="d-flex my-2">
                                    ...
                                    <a href="#" class="btn btn-primary me-3" data-kt-drawer-show="true"
                                        data-kt-drawer-target="#kt_drawer_chat">Chiết khấu <?php if($username!=""){echo ($user['chiet_khau']);}else{echo'0';}?>%</a>
                                    <!--begin::Menu-->
                                    <div class="me-0">
                                        ...
                                        <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-800 menu-state-bg-light-primary fw-bold w-200px py-3"
                                            ...
                                            <!--begin::Menu item-->
                                            <div class="menu-item px-3">
                                                <a href="/nap-tien" class="menu-link px-3">Nạp tiền</a>
                                            </div>
                                            <!--end::Menu item-->
                                        </div>
                                        <!--end::Menu 3-->
                                    ...
                                    <div class="d-flex flex-wrap">
                                        ...
                                        <div
                                            ...
                                            <div class="d-flex align-items-center">
                                                ...
                                                <div class="fs-2 fw-bolder" data-kt-countup="true"
                                                    data-kt-countup-value="<?=$user['money'];?>">
                                                    0</div>
                                            </div>
                                            <!--end::Number-->
                                            <!--begin::Label-->
                                        ...
                                        <div
                                            ...
                                            <div class="d-flex align-items-center">
                                                ...
                                                <!--end::Svg Icon-->
                                                <div class="fs-2 fw-bolder" data-kt-countup="true"
                                                    data-kt-countup-value="<?=$user['tong_nap'];?>">0</div>
                                            </div>
                                            <!--end::Number-->
                                            <!--begin::Label-->
                                            <div class="fw-bold fs-6 text-gray-400">Đã nạp</div>
                                            <!--end::Label-->
                                        </div>
                                        <!--end::Stat-->
                                        <!--begin::Stat-->
                                        <div
                                            ...
                                            <div class="d-flex align-items-center">
                                                ...
                                                <!--end::Svg Icon-->
                                                <div class="fs-2 fw-bolder" data-kt-countup="true"
                                                    data-kt-countup-value="<?=$user['tong_nap']-$user['money'];?>">0
                                                </div>
                                            </div>
                                            <!--end::Number-->
                                            <!--begin::Label-->
                                            <div class="fw-bold fs-6 text-gray-400">Đã dùng</div>
                                            <!--end::Label-->
                                        </div>
                                        <!--end::Stat-->
                                    </div>
                    ...
                    <div class="d-flex overflow-auto h-55px">
                        <ul
                            ...
                            <li class="nav-item">
                                ...
                                <a class="nav-link text-active-primary me-6 active" href="/password">Password</a>
                                <a class="nav-link text-active-primary me-6" href="/telegram">Telegram</a>
                            </li>
                            <!--end::Nav item-->
                        </ul>
                    </div>
        ...
        <div class="row mb-6">
            ...
            <div class="col-lg-7 fv-row">
                <input type="text" name="username" id="username" class="form-control form-control-lg form-control-solid"
        ...
        <div class="row mb-6">
            ...
            <!--begin::Col-->
            <div class="col-lg-7 fv-row">
                <input type="text" name="pwm1" id="pwm1"
                    class="form-control form-control-lg form-control-solid" placeholder="Nhập mật khẩu bạn muốn thay đổi" />
            </div>
            <!--end::Col-->
        </div>
        <div class="row mb-6">
            <!--begin::Label-->
            <label class="col-lg-4 col-form-label required fw-semibold fs-6">Nhập lại mật khẩu mới</label>
            <!--begin::Col-->
            <div class="col-lg-7 fv-row">
                <input type="text" name="pwm2" id="pwm2"
                    class="form-control form-control-lg form-control-solid" placeholder="Nhập mật khẩu bạn muốn thay đổi" />
            </div>
            <!--end::Col-->
        </div>
        ...
        <button class="btn btn-primary" id="kt_account_profile_details_submit" type="button" onclick="thaypass()">Lưu ngay</button>
    </div>
    <script>
        function thaypass() {
            ...
            xhr.send(
                ...
                "&pwm1=" + encodeURIComponent(pwm1) +
                "&pwm2=" + encodeURIComponent(pwm2)
