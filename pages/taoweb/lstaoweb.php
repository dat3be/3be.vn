                                ...
                                <div class="card card-xl-stretch mb-5 mb-xl">
                                    ...
                                    <div class="card-header border-0 pt-5">
                                        <h3 class="card-title align-items-start flex-column">
                                            <span class="card-label fw-bolder fs-3 mb-1">Lịch sử tạo web</span>
                                            <span class="text-muted mt-1 fw-bold fs-7">Cập nhật <?=$time;?></span>
                                        </h3>
                                        <div class="card-toolbar" data-bs-toggle="tooltip" data-bs-placement="top"
                                            data-bs-trigger="hover" title="Bấm để kiểm tra lại lịch sử tạo">
                                        ...
                                        <div class="table-responsive">
                                            ...
                                            <table
                                                ...
                                                <thead>
                                                    <tr class="fw-bolder text-muted">
                                                        ...
                                                        <th class="min-w-100px text-center">Loại Web</th>
                                            ...
                                            while($row = mysqli_fetch_assoc($result)) { ?>
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <center><?=status($row['status']);?><center>
                                                        </td>

                                                        <td>
                                                        <div class="d-flex justify-content-end flex-shrink-0">
                                                              <a href="/history-reg-web/<?=$row['id'];?>"
