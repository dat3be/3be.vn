...
if($check_mien->num_rows == 1){
    ...
    $toz_mien = $ketnoi->query("SELECT * FROM `history_domain` WHERE `id` = '".$toz_rec['id_domain']."' ")->fetch_array();
                    ...
                    <div class="main-content ">
                        <div class="card border">
                            ...
                            <div class="row gx-5 gx-xl-10">
                                ...
                                <div class="col-xl-12">
                                    ...
                                    <div class="col-lg-10 fv-row">
                                        <input type="text" name="name" id="name" value="<?=$toz_rec['name'];?>"
                                ...
                                <div class="col-xl-12">
                                    ...
                                    <div class="col-lg-10 fv-row">
                                        <input type="text" name="content" id="content" value="<?=$toz_rec['content'];?>"
                                            class="form-control form-control-lg form-control-solid"
                        ...
                        <div class="card-footer d-flex justify-content-end py-6 px-9">
                            ...
                            <button class="btn btn-primary" type="button" onclick="luu()">
                                <span id="button1" class="indicator-label">Lưu Bản Ghi</span>
                ...
                function luu() {
                    ...
                    Swal.fire({
                        ...
                        if (result.isConfirmed) {
                            ...
                            xhr.open("POST", "/ajax/domain/edit-record.php");
