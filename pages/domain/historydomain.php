...
<head>
    ...
    <title>Lịch Sử Mua Miền | <?=$chinhapi['ten_web'];?></title>
                                ...
                                <div class="card card-xl-stretch mb-5 mb-xl">
                                    ...
                                    <div class="card-header border-0 pt-5">
                                        <h3 class="card-title align-items-start flex-column">
                                            <span class="card-label fw-bolder fs-3 mb-1">Lịch sử mua miền</span>
                                    ...
                                    <div class="card-body py-3">
                                        ...
                                        <div class="table-responsive">
                                            ...
                                            <table
                                                ...
                                                <tbody>
                                                <?php
                                            $result = mysqli_query($ketnoi,"SELECT * FROM `history_domain` WHERE `username` = '$username' ORDER BY id");
                                            while($row1 = mysqli_fetch_assoc($result)) { ?>
                                                    ...
                                                    <td>
                                                        <div class="text-dark fw-bold text-hover-primary d-block fs-6">
                                                            <center><?=$row1['id'];?></center>
                                                        </div>
                                                    </td>

                                                    <td>
                                                        <a href="https://<?=$row1['tenmien'].$row1['duoimien'];?>/"
                                                    ...
                                                    <td>
                                                        <a class="text-dark fw-bold text-hover-primary d-block fs-6">
                                                            <center>
                                                                <?php echo date('h:i d-m-Y', $row1['ngaymua']); ?>
                                                            </center>
                                                        </a>
                                                    </td>
                                                    ...
                                                    <td>
                                                        <a class="text-dark fw-bold text-hover-primary d-block fs-6">
                                                            <center>
                                                                <?php echo date('h:i d-m-Y', $row1['ngayhet']); ?>
                                                            </center>
                                                        </a>
                                                    </td>

                                                    <td>
                                                        <center><?=status($row1['status']);?><center>
                                                    </td>

                                                    <td>
                                                        <div class="d-flex justify-content-end flex-shrink-0">
                                                            <a href="/quan-ly-mien/<?=$row1['id'];?>"
