                                ...
                                <div class="card card-xl-stretch mb-5 mb-xl">
                                    ...
                                    <div class="card-header border-0 pt-5">
                                        <h3 class="card-title align-items-start flex-column">
                                            <span class="card-label fw-bolder fs-3 mb-1">Lịch sử mua bản quyền</span>
                                        ...
                                        <div class="table-responsive">
                                            ...
                                            <table
                                                ...
                                                <thead>
                                                    <tr class="fw-bolder text-muted">
                                                        ...
                                                        <th class="min-w-150px">Key License</th>
                                            ...
                                            while($row = mysqli_fetch_assoc($result)) { ?>
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <a href=""
                                                                class="text-dark fw-bolder text-hover-primary d-block fs-6" id="key"><?=$row['license'];?></a>
                                                                <i class="fa-regular fa-copy" id="copy-key" onclick="copyApiKey()"></i>
                        </div>
                        <script>
                        function copyApiKey() {
                            // Get the API key element by its id
                            var apiKeyElement = document.getElementById('key');

                            // Create a temporary input element to copy the text to the clipboard
                            var tempInput = document.createElement('input');
                            tempInput.value = apiKeyElement.innerText;
                            ...
                            // Provide a visual indication or alert to the user (optional)
                            alert('Copy Thành Công License: ' + apiKeyElement.innerText);
                        }
                        </script>
                                                        </td>
                                                        <td>
                                                            <a 
                                                                class="text-dark fw-bolder text-hover-primary d-block fs-6"><?=$row['mien'];?></a>
                                                        </td>
                                                        <td>
                                                     
                                                            <a
                                                                class="text-dark fw-bolder text-hover-primary d-block fs-6"><?=license($row['status']);?></a>
