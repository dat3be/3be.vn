                    ...
                    <div id="kt_app_content" class="app-content flex-column-fluid">
                        ...
                        <div class="container-xxl" id="kt_content_container">
                            ...
                            <div class="row gy-5 g-xl-8">
                                                                ...
                                                                <!--begin::item-->
                                <?php
                                    $result = mysqli_query($ketnoi,"SELECT * FROM `list-license` WHERE `status`='ON' ORDER BY `id` DESC ");
                                    while($row = mysqli_fetch_assoc($result)) { ?>
                            <!--begin::item-->
                            <div class="col-xl-4 ">
                                <div class="card shadow-sm card card-xl-stretch mb-5 mb-xl-4">
                                      ...
                                      <div class="w-100 d-flex flex-column flex-center rounded-3 bg-opacity-55 py-8 px-8">
                                                ...
                                                <div class="mb-3 text-center position-relative">
                                                    ...
                                                    <div class="text-center">
                                                        <span class="text-gray-700 fw-semibold d-block">
															<strong>
                                                ...
                                                <!--begin::Select-->
                                                <a href="/ban-quyen/<?=$row['id'];?>" class="btn btn-sm btn-primary "><i class="fas fa-shopping-cart mr-1"></i>Xem
                                            Ngay</a>
