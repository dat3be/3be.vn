...
if (isset($_GET['del'])) {
    $del = $_GET['del'];
    echo '<script> if (confirm("Bạn có chắc muốn xoá bản quyền này")) {
...
if (isset($_GET['delete'])) 
{
    ...
    $create = mysqli_query($ketnoi,"DELETE FROM `list-license` WHERE `id` = '".$delete."' ");
        ...
        <div class="content-wrapper">
            ...
            <div class="content-header">
                <div class="container-fluid">
                    <div class="row mb-2">
                        <div class="col-sm-6">
                            <h1 class="m-0">Danh sách bản quyền</h1>
                        </div><!-- /.col -->
                        <div class="col-sm-6">
                        ...
                        <div class="col-md-12">
                            <div class="card">
                                <div class="card-header">
                                    <h3 class="card-title">Danh sách bản quyền</h3>
                                    <div class="text-right">
                                        <a class="btn btn-primary btn-icon-left m-b-10" href="add-bq.php"
                                            type="button"><i class="fas fa-plus-circle mr-1"></i>Thêm Bản Quyền</a>
                                    </div>
                                </div>
                                <table id="datatable1" class="table table-bordered table-striped">
                                    ...
                                    <tbody>
                                        <?php
                                $result = mysqli_query($ketnoi,"SELECT * FROM `list-license` ORDER BY id desc ");
                                ...
                                ?>
                                        <tr>
                                            ...
                                            <td><?=$row['name'];?></td>
                                            <td><?=$row['status'];?></td>
                                            <td><?=tien($row['money']);?>đ</td>
                                            </td>
                                            <td>
                                            <a href="edit-bq.php?id=<?=$row['id'];?>" class="btn btn-default">
