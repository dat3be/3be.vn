...
if (isset($_GET['delete'])) 
{
    ...
    $create = mysqli_query($ketnoi,"DELETE FROM `giaweb` WHERE `id` = '".$delete."' ");
        ...
        <div class="content-wrapper">
            ...
            <div class="content-header">
                <div class="container-fluid">
                    <div class="row mb-2">
                        <div class="col-sm-6">
                            <h1 class="m-0">Danh sách Giá WEB</h1>
                        </div><!-- /.col -->
                        <div class="col-sm-6">
                            <ol class="breadcrumb float-sm-right">
                                <li class="breadcrumb-item"><a href="#">Home</a></li>
                                <li class="breadcrumb-item active">Giá WEB</li>
                            </ol>
                        </div><!-- /.col -->
                    </div><!-- /.row -->
                </div><!-- /.container-fluid -->
                        ...
                        <div class="col-md-12">
                            <div class="card">
                                <div class="card-header">
                                    <h3 class="card-title">Danh sách Giá WEB</h3>
                                    <div class="text-right">
                                        <a class="btn btn-primary btn-icon-left m-b-10" href="add-giaweb.php"
                                            type="button"><i class="fas fa-plus-circle mr-1"></i>Thêm Giá WEB</a>
                                    </div>
                                </div>
                                <div class="card-body">
                                ...
                                <table id="datatable1" class="table table-bordered table-striped">
                                    ...
                                    <tbody>
                                        <?php
                                $result = mysqli_query($ketnoi,"SELECT * FROM `giaweb` ORDER BY id desc ");
                                ...
                                ?>
                                        <tr>
                                            ...
                                            <td>
                                                <a href="edit-giaweb.php?id=<?=$row['id'];?>" class="btn btn-default">
